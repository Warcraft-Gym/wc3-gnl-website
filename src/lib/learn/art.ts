...
const TOPIC_ART: Record<string, string> = {
  "new-players": "/graphics/new-players-1.webp",
  "creep-routes": "/graphics/creep-routes-1.webp",
  mechanics: "/graphics/game-mechanics-1.webp",
};
...
export function learnArt(c: LearnCategory): string | null {
  if (c.kind === "race" && c.race) return `/factions/large/${c.race}.webp`;
